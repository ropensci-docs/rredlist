...
Return a list of the latest assessments based on the stresses species
are subject to (e.g., Ecosystem degradation, species disturbance, etc.).
...
- code:
  ...
  (character) The code of the stress to look up. If not supplied, a list
  of all stresses will be returned.
