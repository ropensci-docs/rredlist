...
This endpoint returns categories for the current IUCN Red List
Categories and Criteria (v3.1) as well as older versions (i.e., v2.3).
Note that a code may not be unique across Categories and Criteria
versions. Therefore, codes like "EX" will return assessments for EX v3.1
and EX v2.3.
...
- code:
  ...
  (character) The code of the Red List category to look up. If not
