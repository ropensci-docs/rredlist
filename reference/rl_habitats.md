...
Return the latest assessments for a given habitat (e.g., Forest -
Temperate or Marine Intertidal). These habitat codes correspond to the
IUCN Red List Habitats Classification Scheme (v3.1).
...
- code:
  ...
  (character) The code of the habitat to look up. If not supplied, a
  list of all habitats will be returned.
