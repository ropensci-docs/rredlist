...
Return the latest assessments with a given research needed (e.g.,
Taxonomy or Population trends). These research codes correspond to the
IUCN Red List Research Needed Classification Scheme (v1.0).
...
- code:
  ...
  (character) The code of the research type to look up. If not supplied,
  a list of all research types will be returned.
