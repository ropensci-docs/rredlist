...
Return a list of the latest assessments based on a population trend
...
- code:
  ...
  (character) The code of the growth form to look up. If not supplied, a
  list of all growth forms will be returned.
